          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-red-50 border-l-4 border-canada-red p-6 rounded-r-lg">
              <p className="text-gray-700 italic">
                "We envision a future where Canadians can easily make informed choices to support local 
                businesses, creating a stronger, more sustainable economy for all of us."
              </p>
            </div>
          </div>
        </div>
